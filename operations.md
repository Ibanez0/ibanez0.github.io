...
Je suis particulièrement intéressé par l'exploitation des réseaux modèles, surtout d'un point de vue ludique. Ces quelques pages tentent d'expliquer mon point de vue à ce jour. J'ai construit un [réseau](/reseau) pour me permettre de mettre en pratique les idées exposées ci-dessous. Ce réseau est encore loin d'être achevé, mais il me permet dejà en l'état de valider plusieurs idées et de progresser sur ce sujet.
 
